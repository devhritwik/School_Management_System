...
<c:if test="${pageContext.request.userPrincipal.name != null}">
	...
	<div class="wrapper">
	<form:form method="post" modelAttribute="studentHobbies" action="/dbms/student/editProfile/editHobbies">
		...
		<tr><td>
		Hobby</td><td>
		<form:input path="hobby" type="text" /> </td><!-- bind to user.name-->
		<td><form:errors path="hobby" /></td></tr>
